...
/*
 * @SpringApplicationConfiguration knows how to load and configure 
 * an ApplicationContext , which means that you can have direct 
 * access to all the Spring container classes by just using the @Autowired annotation.
 */
@SpringApplicationConfiguration(classes = SprintBootWebApplication.class)

/*
 * @WebAppConfiguration loads the org.springframework.web.context.WebApplicationContext implementation, 
 * which will ensure that all your files and beans related to the web app are accessible.
 */
@WebAppConfiguration
...
public class SprintBootWebApplicationTests {
    ...
    public void setup() throws Exception {
		//mockMvc can actually be Autowired and don't need do like this
	...
	public void getAll() throws Exception {
		...
		.andExpect(jsonPath("$",iterableWithSize(5))) //because test add run first
